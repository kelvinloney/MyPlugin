	...
	if ( isset( $_GET[ 'settings-updated' ] ) ) {
		...
		?>
			...
			<div class="notice notice-success is-dismissible">
				<p><strong><?php _e( 'Success, congratulations! Your settings are saved.', 'myplugin' ); ?></strong></p>
			</div>
		...
		?>
			...
			<div class="notice notice-error is-dismissible">
				<p><strong><?php _e( 'Whoops, we have a problem. There is an error. Try again.', 'myplugin' ); ?></strong></p>
			</div>
